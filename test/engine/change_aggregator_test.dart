...
void main() {
  ...
  group('ChangeAggregator', () {
    ...
    group('aggregateChanges', () {
      ...
      test('should optimize INSERT followed by UPDATE to a single INSERT',
          () async {
      ...
      test('should keep only DELETE when UPDATE is followed by DELETE',
          () async {
        ...
        expect(
            [ChangeType.delete, ChangeType.update]
                .contains(result.changes[0].operation),
            isTrue);
        expect(result.changes[0].version, 2);
