...
void main() {
  group('ConflictResolver', () {
    ...
    test('should use remote row when strategy is ignore', () {
      final resolver = ConflictResolver(strategy: ConflictResolutionStrategy.ignore);
    ...
    test('should use remote row when strategy is serverWins', () {
      final resolver = ConflictResolver(strategy: ConflictResolutionStrategy.serverWins);
      final result = resolver.resolveConflict(tableName, localRow, remoteRow);
      expect(result, equals(remoteRow));
    });
    
    test('should use local row when strategy is clientWins', () {
      final resolver = ConflictResolver(strategy: ConflictResolutionStrategy.clientWins);
      final result = resolver.resolveConflict(tableName, localRow, remoteRow);
    ...
    test('should throw UnsupportedError when strategy is custom', () {
      ...
      customResolver(String tableName,
    ...
    test('should throw assertion error when custom strategy is used without resolver', () {
      expect(
